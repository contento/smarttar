...
BOOL PASCAL_EXPORT nrGetFmt(char far **format)
{
    ...
    *format =
        ...
        "\tLocalidad: %s\tLocalidad: %s\n"
		"\t%s: %s\t%s: %s\n"
        "\n"
        "\tDuración: %s\tDuración: %s\n"
        "\tMinutos cobrados: %.1f\tMinutos cobrados: %.1f\n"
        "\tValor Minuto: %s%.2f [%d%%]\tValor minuto: %s%.2f [%d%%]\n"
        "\tTotal: %s%.2f %s\tTotal: %s%.2f %s\n"
        ;
    return ok;
}
...
BOOL PASCAL_EXPORT srGetTelexFmt(char far **format)
{
    ...
    *format =
        ...
        "\n"
		"\x1B\x21\x01""\t  Min.: %.1f\t  Min.: %.1f\n"
		"\x1B\x21\x01""\t  Cob.: %.0f\t  Cob.: %.0f\n"
