/*= Archive Library v2.12 ================================================
 ...
 |  ALSpinner monitor.  It adds files to either a CON00.GAL or
...
main()
{
 ...
 printf("%d files added to %s using a newALSpinner monitor.\n",
